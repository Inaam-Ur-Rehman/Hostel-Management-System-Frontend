...
export default function Receipt({ data }) {
  ...
  return (
    <>
      <Button className="max-w-max mr-0 ml-auto">
        <PrinterIcon
          onClick={() => {
      ...
      <div className="mx-auto " ref={contentToPrint}>
        <div className="w-96 rounded bg-gray-50 px-6 pt-8 shadow-lg">
          <img src={Logo} alt="logo" className="mx-auto w-44 py-4" />
          <div className="flex flex-col justify-center items-center gap-2">
            <h4 className="font-semibold">FEE RECEIPT</h4>
          </div>
          <div className="flex flex-col gap-3 border-b py-6 text-xs">
            ...
            <p className="flex justify-between">
              ...
              <span>{data?.user?.profile?.fatherName}</span>
            </p>
            <p className="flex justify-between">
